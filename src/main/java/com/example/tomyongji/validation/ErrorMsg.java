...
public class ErrorMsg {
    ...
    public static final String NOT_HAVE_STUDENT_CLUB = "해당 단과대에 학생회가 속해있지 않습니다.";
    public static final String NOT_VERIFY_EMAIL = "이메일 인증이 되지 않은 유저입니다.";
    public static final String NOT_VERIFY_CLUB = "소속 인증이 되지 않은 유저입니다.";
    ...
    public static final String EROOR_SEND_EMAIL = "이메일 전송 중 오류가 발생했습니다.";
}
