...
import com.example.tomyongji.domain.auth.jwt.JwtAuthenticationFilter;
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                    // actuator 헬스체크와 Prometheus 엔드포인트는 인증 없이 허용
                        ...
                        .requestMatchers("/api/users/**","/swagger-ui/**", "/v3/api-docs/**","/api/csv/**","/api/club/**","/api/collegesAndClubs","/api/excel/**").permitAll()
